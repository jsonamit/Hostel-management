...
//$query="update  userregistration set regNo=$regno,firstName=$fname,middleName=$mname,lastName=$lname,gender=$gender,contactNo=$contactno where id=$aid";
$query="update  userregistration set firstName=?,middleName=?,lastName=?,gender=?,contactNo=?,regNo=? where id=?";
$stmt = $mysqli->prepare($query);
$rc=$stmt->bind_param('sssssii',$fname,$mname,$lname,$gender,$contactno,$regno,$aid);
$stmt->execute();
